...
Ce cahier de recherche couvre quatre piliers fondamentaux qui forment un tout cohérent :
...
Le fil conducteur entre ces quatre chapitres est la \textbf{rigueur progressive} : on part d'un langage formel (logique), on construit des objets (complexes, entiers), puis on étudie leur comportement (suites, divisibilité). Chaque couche s'appuie sur les précédentes.

L'arithmétique boucle la boucle en reliant les mathématiques pures à mon domaine de spécialisation : la cybersécurité. Les mêmes structures --- récurrence, absurde, contraposée --- servent à prouver l'unicité de la décomposition en facteurs premiers comme à montrer la convergence d'une suite.

Ce cahier n'est pas un point d'arrivée mais un point de départ. Les mêmes structures --- limites, complétude, congruences --- se retrouveront dans l'étude des fonctions continues, des séries, de l'algèbre modulaire et de la cryptographie avancée.
\end{intuitionbox}
